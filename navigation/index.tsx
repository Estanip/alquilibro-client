...
import LoginRegister from "../screens/LoginScreen";
  ...
  return (
    <Stack.Navigator>
      <Stack.Screen
        ...
        options={{ ...navBar, title: "Alquilibro", headerRight: undefined }}
      />
      <Stack.Screen
        name="Main"
        component={BottomTabNavigator}
        options={{ ...navBar, title: "Alquilibro" }}
      />
      <Stack.Screen
        name="SearchResults"
      ...
      <Stack.Screen
        ...
        options={{ ...navBar, title: "Subir Libro", headerLeft: undefined }}
      />
      <Stack.Screen
        name="UploadedBook"
        component={UploadedBookScreen}
        options={{
          ...navBar,
          title: "Titulo del Libro",
          headerLeft: undefined,
      ...
      <Stack.Screen
        ...
        options={{ ...navBar, title: "Recomendados", headerLeft: undefined }}
      />
      <Stack.Screen
        name="NotFound"
